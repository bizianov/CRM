          ...
          <td bgcolor="#E6E6E6">
            <table border="1">
              ...
              <tr>
                ...
                <td bgcolor="#F2F2F2"><a href="getHotelsByCountry?country=${tour.hotel.country}">${tour.hotel.country}</a></td>
                <td bgcolor="#F2F2F2"><a href="getHotelsByRegion?region=${tour.hotel.region}">${tour.hotel.region}</a></td>
              </tr>
            </table>
          </td>
